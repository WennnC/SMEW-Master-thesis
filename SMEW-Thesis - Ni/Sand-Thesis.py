...
Group_plot = ['Control - Biochar - Sand','Control - Sand','Dunite - Biochar - Sand','Dunite - Sand','Wollastonite - Biochar - Sand','Wollastonite - Sand']
code_map = {
    'S': 'Control - Sand',
...
Ni_react_init = 53.06e-6 / 59  # mg/kg → mol/kg
#base saturation
...
df_ni = df_ni[
    ...
    df_ni['Treatment'].astype(str).str.contains('Sand', case=False, na=False)
...
axes[0].set_ylabel("Ni in soil (mg/kg)", fontsize=14)

legend_handles = [
    # Model line style (biochar)
    mlines.Line2D([], [], color='gray', linewidth=2,
                  linestyle='-',  label='Model (with biochar)'),
    mlines.Line2D([], [], color='gray', linewidth=2,
                  linestyle='--', label='Model (without biochar)'),
    # HNO3 observed
    mlines.Line2D([], [], color='black', marker='o', linestyle='None',
                  markersize=10, markerfacecolor='black', label='HNO₃ (with biochar)'),
    mlines.Line2D([], [], color='black', marker='o', linestyle='None',
                  markersize=10, markerfacecolor='none', label='HNO₃ (without biochar)'),
    # CaCl2 observed
    mlines.Line2D([], [], color='black', marker='^', linestyle='None',
                  markersize=10, markerfacecolor='black', label='CaCl₂ (with biochar)'),
    mlines.Line2D([], [], color='black', marker='^', linestyle='None',
                  markersize=10, markerfacecolor='none', label='CaCl₂ (without biochar)'),
]
