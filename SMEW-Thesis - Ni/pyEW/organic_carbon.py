...
def respiration(ADD, SOC_in, CO2_air_in, ratio_aut_het, soil, s, v, k_v, Zr, temp_soil,dt,conv_mol,Biochar_Add,k_dec_factor):
    ...
    # Preallocating the variables
        ...
        BIO_fast[0] = Biochar_Add*bio_labile_fraction
        BIO_slow[0] = Biochar_Add*bio_slow_fraction 
    ...
    return(SOC_total, r_het, r_aut, D)