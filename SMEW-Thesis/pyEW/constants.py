...
def min_const(mineral, T_K, conv_mol):
    ...
    if mineral == 'forsterite': #Mg2SiO4
            ...
            n_OH = 1
            min_st = [0, 3, 0, 0, 0, 2]# Stochiometric coefficients [Ca, Mg, K, Na, Al, Si]
            K_sp = np.nan
            ...
            n_OH = 1
            min_st = [0, 1, 0, 0, 0, 2]# Stochiometric coefficients [Ca, Mg, K, Na, Al, Si]
            K_sp = 10**(5.82)
            ...
            n_OH = 1
            min_st = [0, 5, 0, 0, 2, 3]# Stochiometric coefficients [Ca, Mg, K, Na, Al, Si]
            K_sp = np.nan
